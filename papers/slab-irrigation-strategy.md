...
Runtime = required volume ÷ measured flow. The example uses three plants per slab and three 7.6 × 1.2 m tables.
...
Table dimensions and plant countSeven 1 m slabs fit along a 7.6 m table, leaving 300 mm at each end. Two rows give 14 slabs and 42 plants per table; three rows give 21 slabs and 63 plants. Across three tables, that is 126 or 189 plants. Two 150 mm slab rows and one 203 mm air tube occupy 503 mm of table width. Three rows and two tubes occupy 856 mm, leaving 344 mm for gaps and hardware. Each tube in this example has its own 200 mm inlet fan. Check inflated tube dimensions, mounting clearance and measured airflow.
