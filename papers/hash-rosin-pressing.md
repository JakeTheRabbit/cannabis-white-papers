...
summary: "Warm the resin, push it through a fine mesh bag, and collect what runs out — that is rosin, made with no solvents. Quality is fixed before the press: at harvest, in the wash, in the dry. This guide maps the whole chain from trichome to finished concentrate."
track: "Harvest, dry, trim & cure"
read_time: "~22 min read"
diagrams: "8 diagrams"
related: ["gmp-hash-lab", "harvest-dry-trim-cure"]
url: "https://jaketherabbit.github.io/cannabis-white-papers/hash-rosin-pressing.html"
md_url: "https://jaketherabbit.github.io/cannabis-white-papers/papers/hash-rosin-pressing.md"
version: "1.2"
updated: "2026-07-18"
license: "CC BY-NC 4.0"
license_url: "https://creativecommons.org/licenses/by-nc/4.0/"
attribution: "The Cannabis White Papers"
refs: [{"id": "pressclub-temp", "n": 1, "cite": "The Press Club. Rosin press temperature guide (cold-press vs hot-press bands by material; yield/terpene trade). Industry technical guide, not peer-reviewed.", "url": "https://thepressclub.co/blogs/tips-tricks/rosin-press-temperature-guide", "peer": false}, {"id": "pressclub-pressure", "n": 2, "cite": "The Press Club. Rosin press pressure guide (effective PSI at the bag; ramp-to-flow technique). Industry technical guide.", "url": "https://thepressclub.co/blogs/tips-tricks/rosin-press-pressure-guide", "peer": false}, {"id": "pressclub-thca", "n": 3, "cite": "The Press Club. How to make THCa rosin (yield expectations and separation practice). Industry technical guide.", "url": "https://thepressclub.co/blogs/tips-tricks/how-to-make-thca-rosin", "peer": false}, {"id": "pressclub-static", "n": 4, "cite": "The Press Club. Cleaning dry sift with rubber-glove static tech. Industry technical guide.", "url": "https://thepressclub.co/blogs/tips-tricks/cleaning-dry-sift-with-rubber-glove-static-tech", "peer": false}, {"id": "lowtemp-diamonds", "n": 5, "cite": "Lowtemp Industries. How to make solventless diamonds (THCa crystallisation from rosin; decarb destroys diamond potential). Manufacturer knowledge base.", "url": "https://www.lowtemp-plates.com/blogs/knowledge/how-to-make-solventless-diamonds", "peer": false}, {"id": "lowtemp-carts", "n": 6, "cite": "Lowtemp Industries. How to make 100% solventless rosin cartridges (decarb, degas, fridge test, fill). Manufacturer knowledge base.", "url": "https://www.lowtemp-plates.com/blogs/knowledge/how-to-make-100-solventless-rosin-cartridges-lowtemp-industries", "peer": false}, {"id": "triminator-tempchart", "n": 7, "cite": "Triminator. Rosin press temperature chart (per-material bands and dwell times). Manufacturer technical guide.", "url": "https://thetriminator.com/rosin-press-temp-chart/", "peer": false}, {"id": "triminator-coldcure", "n": 8, "cite": "Triminator. How to cold-cure rosin (sealed-jar cold cure for badder; temperature and timing bands). Manufacturer technical guide.", "url": "https://thetriminator.com/how-to-cold-cure-rosin/", "peer": false}, {"id": "triminator-carts", "n": 9, "cite": "Triminator. How to make rosin carts (fill temperature and stability testing). Manufacturer technical guide.", "url": "https://thetriminator.com/how-to-make-rosin-carts/", "peer": false}, {"id": "hightimes-bubbleman", "n": 10, "cite": "Richardson M (‘Bubbleman’). Tricks & tips to make full-melt dry sift hash. High Times (140/107/70 µm three-screen method).", "url": "https://hightimes.com/grow/tricks-tips-to-make-full-melt-dry-sift-hash/", "peer": false}, {"id": "hashtek-thca-tek", "n": 11, "cite": "Hashtek. Mechanical THCa separation tek (progressive low-temperature pressing, ~105-135 °F; hot starts dissolve THCa into the terpene fraction). Practitioner tek.", "url": "https://hashtek.ca/thca-tek/", "peer": false}, {"id": "hashtek-jam-tek", "n": 12, "cite": "Hashtek. Rosin jam tek (sealed jar ~93 °C for 1-2 h, then ~38 °C for 1-2 weeks to crystallise). Practitioner tek.", "url": "https://hashtek.ca/jam-tek/", "peer": false}, {"id": "hashtek-decarb", "n": 13, "cite": "Hashtek. Decarb experiment: lid vs no lid (sealed 71 °C/142 h decarb lost ~3% total terpenes; open-air decarb lost ~12%, monoterpenes worst; mason lids self-vent ~5 psi). Practitioner experiment.", "url": "https://hashtek.ca/decarb-experiment-lid-vs-no-lid/", "peer": false}, {"id": "resinator-bubblepress", "n": 14, "cite": "The Original Resinator. How to press bubble hash into rosin (wash-to-press workflow). Manufacturer guide.", "url": "https://www.theoriginalresinator.com/blog/how-to-press-bubble-hash-into-rosin/", "peer": false}, {"id": "wang2016-decarb", "n": 15, "cite": "Wang M, Wang Y-H, Avula B, et al. (2016). Decarboxylation study of acidic cannabinoids: a novel approach using ultra-high-performance supercritical fluid chromatography/photodiode array-mass spectrometry. Cannabis and Cannabinoid Research 1(1):262-271.", "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC5549281/", "peer": true}, {"id": "eyal2023-terpenes", "n": 16, "cite": "Eyal AM, Berneman Zeitouni D, Tal D, et al. (2023). Vapor pressure, vaping, and corrections to misconceptions related to medical cannabis' active pharmaceutical ingredients' physical properties and compositions. Cannabis and Cannabinoid Research 8(3):414-425.", "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC10249740/", "peer": true}]
---

# Hash rosin: heat, pressure, and a micron screen

_Harvest · Solventless · ~22 min read_
...
> **Diagram.** Trichomes are the target. Solventless hash-making collects these heads and squeezes the resin out of them.

It happens in two halves:

1. **Make the hash.** Knock trichome heads off the plant and gather them into a powder or paste. Two common routes: stir plant material in _ice water_ so the brittle heads snap off and sink (**bubble hash**), or rub dried material over fine _screens_ (**dry sift**).
...
> **Diagram.** Two gently heated plates squeeze the bag. Heat thins the resin; pressure pushes it through the mesh as golden rosin, leaving plant matter trapped inside.

**Trichome** — The tiny resin gland on the plant, the visible ‘crystal’. Its head holds the oil you want.

**Hash** — Trichome heads gathered into a powder or paste, before pressing.

**Rosin** — The oil pressed out of hash (or flower) using only heat and pressure.

**Solventless** — Made with only force, heat, water and ice — never butane, CO₂ or alcohol. That's the appeal.
...
**Cure** — Resting fresh rosin at a set temperature for hours to weeks to fix its texture and flavour.

> **KEY — The one thing this guide builds to**
>
> The press cannot _add_ quality. It can only lose less of it. Your starting material (the genetics, the harvest, the wash) sets the ceiling. Heat, pressure, time and mesh size only decide how close to that ceiling you land.
...
| Term | Meaning |
| --- | --- |
| Amber trichome | A resin head aged past its peak, turned amber. A little adds a heavier body effect; too many means lost potency. |
| Badder / batter | A creamy, whipped rosin texture, like frosting. Set by curing and stirring. |
| Blowout | The mesh bag bursting under pressure so raw plant matter floods the oil and ruins the batch. |
...
| Cold cure | Resting sealed rosin at about 10–21 °C (50–70 °F) for days to weeks to set a creamy badder. |
...
| Pre-press | Forming the material into a dense, air-free puck before pressing, to prevent channels and blowouts. |
...
| Yield | How much rosin you get back, usually as a percentage of the hash weight pressed. |
...
A rosin press has four levers (**heat, pressure, time and screen (micron)**) and they all negotiate a single tension: _yield versus quality_ (terpene retention, colour, clarity)[^pressclub-temp]. Heat lowers resin viscosity so it flows — think of cold honey: stir it and it barely moves, but warm it a few degrees and it pours. The resin in a trichome behaves the same way; the constraint is that the same warmth that frees the oil also drives off the lightest aromatic compounds. The micron bag then decides what flows _with_ the oil (pure trichome oil, or fats and plant matter too); pressure and time only push the process along[^pressclub-pressure]. None of them can lift the ceiling set upstream.

> **KEY — Quality in, quality out**
>
> You cannot press 6-star rosin from 3-star input. The wash, the dry and the grade fix the maximum; the press and the cure only preserve or squander it. Hash presses _cooler_ than flower, and clean full-melt hash blows out if you rush the pressure.
...
> **Diagram.** Eleven stages from living plant to finished concentrate. Blue marks the cold-chain steps where heat is the enemy; amber marks the heat steps — the press and the cure. Follow the arrows.

1. **Harvest** — Cut at 80–90% cloudy trichomes, at lights-off.
2. **Freeze or dry** — Fresh-freeze for live products; slow-dry for dry sift.
3. **Wash or sift** — Ice-water hash or dry-sift screens, cold room, gentle hands.
4. **Dry the hash** — Freeze-dry, or cold air-dry as the budget option.
5. **Grade** — Melt-test and star-grade 1–6★; the grade decides the product options.
6. **Condition** — Moisture check and pre-chill; pre-press pucks for flower and sift only.
7. **Press** — Preheat, slow ramp, hold to flow-stop.
8. **Collect** — Cold tool, fresh parchment, straight into chilled glass.
9. **Pick the product path** — Badder, sauce, diamonds, cart oil or hash-hole core.
10. **Cure** — Cold-cure, warm-cure or a staged crystallisation.
11. **Store** — Sealed glass, cold, dark.
...
| Input material | Bag micron | Plate temp | Band (°C / °F) | Dwell (s) | Pressure approach | Pre-press | Typical products |
| --- | --- | --- | --- | --- | --- | --- | --- |
| Dried flower | 90 µm (75–160) | 88 °C (190 °F) | 82–93 (180–199) | 90–180 | Low–medium; slow 30–60 s ramp as resin flows, then ease to firm contact | Yes | Badder, fresh press; carts at 75 µm |
| Dry sift / kief | 72 µm (25–90 by grade) | 82 °C (180 °F) | 71–88 (160–190) | 60–90 | Low; add _time_, not pressure. Finer material already has good contact | Yes | Badder, diamonds |
| Fresh-frozen hash (5–6★) | 36 µm (25–45) | 71 °C (160 °F) | 60–77 (140–171) | 60–180 | Very low; add heat only if flow stalls. **More pressure is NOT better**. It pushes fats through | Cold puck only | Live rosin, cold-cure badder, live diamonds, carts, hash holes |
| Dried / cured bubble hash | 45 µm (25–90 by grade) | 77 °C (171 °F) | 71–82 (160–180) | 60–120 | Low; a few °C warmer than full-melt to coax flow, but stay gentle | Cold puck only | Badder, diamonds, carts |

*Starting setpoints by material. Dial in from here, one lever per run.*

> **NOTE — Temperature bands at a glance**
>
> **Cold-cure hold (post-press, not platen):** 10–21 °C (50–70 °F) for days to ~2 weeks, sets creamy badder while keeping volatile terpenes[^triminator-coldcure]. **Low-temp press (flavour):** 60–85 °C (140–185 °F), maximum terpene retention, lightest colour; hash ~60–77 °C (140–171 °F), premium flower ~82–88 °C (180–190 °F). **Balanced sweet spot (flower):** 88–99 °C (190–210 °F), strong yield, minimal terpene loss; a good default for unknown _flower_. **High-temp press (yield / sauce / carts):** 99–104 °C (210–219 °F), maximum yield, fastest flow, darker; use it to rescue degraded material[^triminator-tempchart].
...
- Lower platen temperature preserves terpenes and colour; higher temperature buys yield and flow at their expense[^pressclub-temp].
- A tighter (smaller-micron) bag yields _cleaner, lighter_ rosin at _lower_ yield; a coarser bag does the reverse.
- Hash and dry sift press cooler than flower because their heads are already separated from plant matter.
- Sealed heat preserves terpenes better than open-air heat: a sealed headspace saturates so net evaporation stops, while open air oxidises and strips them[^hashtek-decarb]. The lightest monoterpenes are the most volatile and go first[^eyal2023-terpenes].
- Only **THCa** crystallises into diamonds; once decarboxylated to THC it stays liquid[^lowtemp-diamonds]. Carts need full decarb; diamonds need preserved THCa.

#### Assumptions this guide makes

- Your hash is well-made and _properly dried_ (freeze-dried or correctly cold-dried) before it reaches the plates.
...
> **KEY — The master tension**
>
> All four balances feed one trade: **yield ↔ quality**. Almost every adjustment trades one for the other. Decide which you are optimising _before_ you touch a lever.
...
| Pre-press | Forms a dense, air-free puck | Reduces channelling and blowouts (flower / sift); skip for full-melt hash |
...
The pattern to remember: **temperature and micron are your quality levers; pressure and time are your finishing levers.** Reach for heat and screen first; use force only to complete a flow that heat has already started[^pressclub-pressure].
...
| --- | --- | --- |
| Low yield, oil won't flow / reabsorbs | Temp too low · material too dry · pressure too low · screen too tight | +3–6 °C (+5–11 °F); check moisture; firmer, slower ramp; open the micron one step |
...
| Stays sappy, won't butter | Not nucleated | Cold-cure in a sealed jar at 13–16 °C (55–61 °F) for 24–72 h |
...
| --- | --- | --- |
| Terpene retention | ↓ | Volatile monoterpenes (α-pinene, myrcene) start leaving as temperature climbs[^eyal2023-terpenes] |
...
> **WARN — When to take the +6 °C (+11 °F)**
>
...
Everything downstream is capped here. The common practice target is **80–90% milky / cloudy** capitate-stalked trichomes with **10–20% amber** and zero clear — a preference band, not a hard rule, and hash-makers often run _less_ amber because amber heads press darker and greasier. Harvesting at lights-off is common practice rather than settled science. For dry sift, lean slightly earlier — overripe stalks turn brittle and fragment into contamination[^hightimes-bubbleman].
...
- **Slow dry (for dry sift):** whole-plant hang at **15–18 °C (59–64 °F), 55–60% RH**, complete darkness, gentle airflow, **10–14 days**. Target stems that snap (not bend), water activity **0.58–0.62 aw** (0.55–0.65 is the safe band; at 0.55 you are already at the overdried boundary). Then freeze the trimmed material 4–6 h (ideally 24 h) so the stalks snap cleanly[^hightimes-bubbleman].

#### Ice-water wash (cold chain)

For bubble hash, agitate fresh-frozen material in near-freezing water so trichome heads break free and sink through a micron bag stack[^resinator-bubblepress].
...
No water — work frozen material across a descending screen cascade in a cold room (below 10 °C / 50 °F), carding gently 3–5 min per pass[^hightimes-bubbleman].
...
- **Static glove tek:** on a 70 µm (200 LPI) screen, sweep a freezer-chilled black nitrile glove in smooth circles. Static lifts pure heads and leaves contaminants behind. Whisk off, re-chill, repeat 3–5 passes. Hover and sweep; never mash[^pressclub-static].
...
> **NOTE — Do you even press 6★?**
>
> Worth knowing: many hash-makers treat **3–4★ as the classic pressing grade** and keep true 5–6★ full-melt to dab as-is[^pressclub-temp]. It already melts clean without a press. Pressing full-melt into rosin is a choice about texture and product form, not an upgrade.
...
3. Hold at working force for **60–120 s** (up to 180 s) or until flow stops — press _to flow-stop_, not to a number[^pressclub-pressure].
4. Release. Yield from clean 5–6★ input typically runs **60–80%**[^pressclub-thca] — if you're under 50% on good input, something upstream is wrong.

> **Diagram.** Preheat with little pressure, then ramp up slowly and hold until flow stops. Rushing the ramp (red) spikes pressure before the resin can escape and bursts the bag.
...
| --- | --- | --- | --- | --- |
| Manual lever | 0.5–5 t | 0.5–12 g (0.018–0.42 oz) | Personal → craft | Fine for small hash runs; force is harder to hold steady |
| Hydraulic | 5–25 t | 4–150 g (0.14–5.3 oz) | Craft → commercial | The workhorse; pair with PID plates for accuracy |
| Pneumatic | 5–8 t | 7–35 g (0.25–1.2 oz) | Craft → commercial | Smooth, repeatable ramp — ideal for gentle hash pressing |
| Electric / hybrid | 0.75–20 t | 1–115 g (0.035–4.1 oz) | Personal → commercial | Hands-free; app / PID control for tight low-temp accuracy |
...
> **Diagram.** Bigger, cleaner heads can use a coarser bag for more yield. Small heads and broken fragments slip through or clog a coarse screen, so they need a tighter bag and a slower, gentler ramp.

| Material / trichome read | Bag micron | Plate temp | Ramp | Best product |
| --- | --- | --- | --- | --- |
| Heads >100 µm, low contaminant | 90 µm (115 if very clean flower) | cool end | gentle | Badder |
| Heads 70–100 µm | 45–73 µm | 88–99 °C (190–210 °F) flower / cooler hash | moderate | Badder / live |
| Heads <70 µm or high fines | 25–37 µm | slightly higher to push through | slow, don't overfill | Careful, blowout-prone |
| Mostly cloudy + high intact % | match head size | 71–85 °C (160–185 °F) | gentle | Cold-cure badder |
| Low intact % (ruptured / degraded) | match head size | 99–104 °C (210–219 °F), shorter dwell | moderate | Carts / sauce |
| High contaminant % | tighter (25–37 µm) | + a few °C | firm pre-press, slow ramp | Recover, don't chase melt |
| Fresh-frozen hash (clean, large heads) | 36–90 µm | 60–85 °C (140–185 °F) | gentle | Live rosin |

> **KEY — The rule the matrix encodes**
>
...
> **Diagram.** The press gives you fresh rosin; the cure decides what it becomes. Same starting oil, very different finished products.

| Product | Press setpoint | Cure / finish | Result |
| --- | --- | --- | --- |
| Fresh-press live rosin | Cool 60–77 °C (140–171 °F, hash) | Use fresh; keep cold | Sappy, terpene-forward |
| Cold-cure badder / jam | Cool press | Sealed jar **10–21 °C (50–70 °F)**, days–2 weeks[^triminator-coldcure] | Creamy, buttery |
| Sauce | Cool press, then nucleate | Warm cure | Wet, high-terpene |
| Diamonds & sauce (mechanical separation) | Nucleate first (cold cure 13–16 °C / 55–61 °F) | Progressive press **40 → 46 → 52 → 57 °C (104 → 115 → 126 → 135 °F)**[^hashtek-thca-tek]; briefly melt the THCa puck to pour (community practice ~120–130 °C / 248–266 °F, hot enough to start decarb — keep it short); recombine with the sauce to taste (~70/30 is a common ratio) | Clear diamonds in sauce |
| Diamonds (jar / jam tek) | Press clean rosin | Sealed jar: heat **93 °C (199 °F), 1–2 h**, then crystallise at **38 °C (100 °F) for 1–2 weeks**[^hashtek-jam-tek] | Crystal balls in jam |
| Vape / cart oil | Press clean & cool (low-lipid hash is ideal) | Decarb sealed, low and slow: whole rosin at ~71 °C (160 °F) for ~6 days measured only ~3% terpene loss[^hashtek-decarb]; hotter sealed decarbs are faster but cost terps[^lowtemp-carts]. Degas, fridge-test 24 h, fill at ~32 °C (90 °F)[^triminator-carts] | Clear, stable cart oil |
| Hash hole core | Cool 60–77 °C (140–171 °F), cohesive full-melt | Roll to a rope while pliable | A donut core that melts clean |

*One press, many products: the cure is the fork in the road.*

> **DANGER — The one irreversible rule**
>
> **Never start a diamond press hot.** At high temperature THCa dissolves _into_ the terpenes and flows out with them — your diamonds leave with the sauce[^hashtek-thca-tek]. Think of salt in hot water: the hotter the water, the more stays dissolved and the less crystallises on cooling. Progressive low-temp pressing removes terpenes gradually so the THCa runs out of solvent and stays behind. And decarboxylation is one-way[^wang2016-decarb]: decarbed THC will never crystallise[^lowtemp-diamonds].

> **WARN — Sealed vessels build pressure**
>
...
The bag ruptures and contamination floods the slab. **Cause:**
pressure ramped too fast, bag overfilled, micron too coarse for the heads, or no support sleeve. **Fix:**
120–160 µm outer sleeve, slow 15–20 s ramp, smaller load, micron matched to head size. Let heat lead; force follows.

**F-02 · Low yield / won't flow**

Oil stalls or reabsorbs into the puck. **Cause:**
temp too low, material too dry, pressure too low, or screen too tight for the heads. **Fix:**
+3–6 °C (+5–11 °F); condition moisture; firmer, slower ramp; open the micron one step.

**F-03 · Hazy / unstable / wet**

Cloudy rosin that separates. **Cause:**
excess moisture (under-dried hash, wet flower) causing emulsion, or a high-lipid flower. **Fix:**
dry and condition the input (freeze-dry hash fully; flower ~60% RH); press cooler; tighten the bag.

**F-04 · Flat, terpene-stripped**

Weak nose, dull flavour. **Cause:**
plate too hot, dwell too long, hot collection, or poor storage. **Fix:**
drop into the cold-press band; shorten dwell; collect cold; store sealed, cold and dark.

**F-05 · Dark or green rosin**

Colour headed the wrong way. **Cause:**
overheated, over-pressed, or contaminated low-grade input. **Fix:**
lower temp; gentler ramp; tighten micron; start from cleaner 5–6★ material. Colour is mostly an input problem.

**F-06 · Auto-budders vs won't butter**

Texture with a mind of its own. **Cause:**
residual moisture makes it auto-budder greasy; fresh sap simply hasn't nucleated. **Fix:**
control input moisture; to butter on purpose, cold-cure sealed at 13–16 °C (55–61 °F) for 24–72 h.

**F-07 · Diamonds won't form**

No crystals, no terpene layer. **Cause:**
cure temperature too high (THCa stays dissolved), material already decarbed, not nucleated, or the wrong terpene ratio. **Fix:**
drop to ~38 °C (100 °F); start from fresh, undecarbed, nucleated rosin; press progressively — never start hot.

**F-08 · Batch-to-batch inconsistency**

Every run a surprise. **Cause:**
...
1. **Fix the input ceiling first** — Genetics, harvest maturity, wash / sift quality and moisture set the maximum. You cannot out-press bad input.
2. **Pick the product** — Badder, live rosin, diamonds, cart or hash hole. This choice sets the temperature band and the cure.
3. **Choose the micron from head size & contamination** — Big clean heads → coarser; small heads or fines → tighter. Don't chase a small micron for its own sake.
4. **Set the temperature band for material × product** — The lowest temperature that still flows. Hash cool, flower warmer, degraded material warmer still.
5. **Ramp pressure to flow, never chase pressure** — Heat first, force second. Pressure only completes a flow that heat has already started.
...
| --- | --- | --- |
| Yield far below 50% on a good grade | Temp / pressure too low, or material too dry | Confirm platen temp; check moisture; firmer slow ramp; +3–6 °C (+5–11 °F) |
...
| Diamonds won't crystallise | Cure temp too high, or decarbed / un-nucleated rosin | Drop to ~38 °C (100 °F); confirm fresh, nucleated, undecarbed rosin |
...
[^pressclub-temp]: The Press Club. Rosin press temperature guide (cold-press vs hot-press bands by material; yield/terpene trade). Industry technical guide, not peer-reviewed. https://thepressclub.co/blogs/tips-tricks/rosin-press-temperature-guide (industry/manufacturer source)
[^pressclub-pressure]: The Press Club. Rosin press pressure guide (effective PSI at the bag; ramp-to-flow technique). Industry technical guide. https://thepressclub.co/blogs/tips-tricks/rosin-press-pressure-guide (industry/manufacturer source)
[^pressclub-thca]: The Press Club. How to make THCa rosin (yield expectations and separation practice). Industry technical guide. https://thepressclub.co/blogs/tips-tricks/how-to-make-thca-rosin (industry/manufacturer source)
[^pressclub-static]: The Press Club. Cleaning dry sift with rubber-glove static tech. Industry technical guide. https://thepressclub.co/blogs/tips-tricks/cleaning-dry-sift-with-rubber-glove-static-tech (industry/manufacturer source)
[^lowtemp-diamonds]: Lowtemp Industries. How to make solventless diamonds (THCa crystallisation from rosin; decarb destroys diamond potential). Manufacturer knowledge base. https://www.lowtemp-plates.com/blogs/knowledge/how-to-make-solventless-diamonds (industry/manufacturer source)
[^lowtemp-carts]: Lowtemp Industries. How to make 100% solventless rosin cartridges (decarb, degas, fridge test, fill). Manufacturer knowledge base. https://www.lowtemp-plates.com/blogs/knowledge/how-to-make-100-solventless-rosin-cartridges-lowtemp-industries (industry/manufacturer source)
[^triminator-tempchart]: Triminator. Rosin press temperature chart (per-material bands and dwell times). Manufacturer technical guide. https://thetriminator.com/rosin-press-temp-chart/ (industry/manufacturer source)
[^triminator-coldcure]: Triminator. How to cold-cure rosin (sealed-jar cold cure for badder; temperature and timing bands). Manufacturer technical guide. https://thetriminator.com/how-to-cold-cure-rosin/ (industry/manufacturer source)
[^triminator-carts]: Triminator. How to make rosin carts (fill temperature and stability testing). Manufacturer technical guide. https://thetriminator.com/how-to-make-rosin-carts/ (industry/manufacturer source)
[^hightimes-bubbleman]: Richardson M (‘Bubbleman’). Tricks & tips to make full-melt dry sift hash. High Times (140/107/70 µm three-screen method). https://hightimes.com/grow/tricks-tips-to-make-full-melt-dry-sift-hash/ (industry/manufacturer source)
[^hashtek-thca-tek]: Hashtek. Mechanical THCa separation tek (progressive low-temperature pressing, ~105-135 °F; hot starts dissolve THCa into the terpene fraction). Practitioner tek. https://hashtek.ca/thca-tek/ (industry/manufacturer source)
[^hashtek-jam-tek]: Hashtek. Rosin jam tek (sealed jar ~93 °C for 1-2 h, then ~38 °C for 1-2 weeks to crystallise). Practitioner tek. https://hashtek.ca/jam-tek/ (industry/manufacturer source)
[^hashtek-decarb]: Hashtek. Decarb experiment: lid vs no lid (sealed 71 °C/142 h decarb lost ~3% total terpenes; open-air decarb lost ~12%, monoterpenes worst; mason lids self-vent ~5 psi). Practitioner experiment. https://hashtek.ca/decarb-experiment-lid-vs-no-lid/ (industry/manufacturer source)
[^resinator-bubblepress]: The Original Resinator. How to press bubble hash into rosin (wash-to-press workflow). Manufacturer guide. https://www.theoriginalresinator.com/blog/how-to-press-bubble-hash-into-rosin/ (industry/manufacturer source)
