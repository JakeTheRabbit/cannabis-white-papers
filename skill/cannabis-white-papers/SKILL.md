...
2. Read only the relevant `papers/<slug>.md` (progressive disclosure, do not load all 38).
...
- **Source water, RO and alkalinity** (`papers/water-quality.md`): Source water, RO & alkalinity
...
- **Root-zone state estimation with the TEROS-12 sensor** (`papers/root-zone-teros12.md`): What the sensor really sees
- **The smart watering brain (VRWE), in plain English** (`papers/smart-watering-vrwe.md`): The watering brain, plain English
- **Signal and noise: precision cultivation** (`papers/signal-and-noise.md`): Real signal vs sensor noise
- **The closed loop: levers, signal and plant state** (`papers/closed-loop.md`): Levers, signal & plant state
- **From telemetry to intelligence: the plant-state dashboard** (`papers/plant-state-dashboard.md`): From telemetry to intelligence
...
- **DIY plant-biosignal sensor: read a plant's electrical signals** (`papers/plant-biosignal-sensor.md`): Read a plant's electrical signals for ~NZ$110
