  ...
  "blocks": [
    ...
    callout("key", "How to sell chemistry without overselling it",
      p("State what you measured: cannabinoid ratio, total terpenes, the top five by weight, harvest and "
        ...
        "In a medicinal framework this is not just honesty — it is compliance.")),
  ]})
...
SECTIONS.append({"id": "grower-levers", "kicker": "Control, honestly ranked", "title": "What the Grower Actually Controls",
  "blocks": [
    p("Ranked by leverage, with the evidence state attached — because this is where vendor claims and "
