  ...
  "blocks": [
    ...
    kv([
      ("Holder + site", "A licence binds a legal person to a physical address. New entity, new "
       "premises, new rooms &mdash; usually a variation or a new application, before the change, "
       "not after."),
      ("Activities", "The named things you may do. Doing an unlisted activity &mdash; extracting "
       "when licensed only to cultivate, supplying when licensed only to grow &mdash; is operating "
