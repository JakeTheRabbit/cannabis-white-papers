...
REFS = {
    ...
    "goto1992-tipburn": {"cite": "Goto E, Takakura T (1992). Prevention of lettuce tipburn by supplying air to inner leaves. <em>Transactions of the ASAE</em> 35(2):641-645.", "url": "https://doi.org/10.13031/2013.28644", "peer": True},
    "ahmed2020-multifan": {"cite": "Ahmed HA, Tong YX, Yang QC (2020). Lettuce plant growth and tipburn occurrence as affected by airflow using a multi-fan system in a plant factory with artificial light. <em>J. Thermal Biology</em> 88:102496.", "url": "https://doi.org/10.1016/j.jtherbio.2019.102496", "peer": True},
    "moosavi2025-vaf": {"cite": "Moosavi-Nezhad M, Meng Q (2025). A calcium-mobilizing biostimulant provides tipburn control comparable to vertical airflow fans in greenhouse hydroponic lettuce 'Rex'. <em>Front. Plant Sci.</em> 16:1701667.", "url": "https://doi.org/10.3389/fpls.2025.1701667", "peer": True},
    "bartok-haf": {"cite": "Bartok JW, Grubinger V. Horizontal air flow is best for greenhouse air circulation. <em>UMass Extension Greenhouse &amp; Floriculture / eXtension Farm Energy</em> (extension fact sheet).", "url": "https://farm-energy.extension.org/horizontal-air-flow-is-best-for-greenhouse-air-circulation/", "peer": False},
    "uconn-haf": {"cite": "University of Connecticut Integrated Pest Management. Horizontal air flow systems. <em>UConn CAHNR</em> (extension fact sheet).", "url": "https://ipm.cahnr.uconn.edu/horizontal-air-flow-systems/", "peer": False},
    "perfduct2025": {"cite": "Wang C, Fu J, Zhang Q, Sheng B, He F, Zhang G, Ding X, Cao N (2025). Optimizing perforated duct systems for energy-efficient ventilation in semi-closed greenhouses through process regulation. <em>Processes (MDPI)</em> 13(7):2253.", "url": "https://doi.org/10.3390/pr13072253", "peer": True},
    "amca-fanlaws": {"cite": "Air Movement and Control Association International (AMCA). Fan laws (affinity laws): airflow varies with fan speed, pressure with the square of speed, shaft power with the <em>cube</em> of speed. Standard fan-engineering relationship.", "url": "https://www.amca.org/", "peer": False},
    "vas-inrack": {"cite": "Vertical Air Solutions / Pipp Horticulture. In-rack airflow systems for vertical cannabis racking (manufacturer documentation).", "url": "https://pipphorticulture.com/in-rack-airflow-systems/", "peer": False},
    ...
    "grodan-block-slab-interaction": {"cite": "Grodan (ROCKWOOL Group). The right block-slab interaction ensures healthy plants (the slab's greater height exerts suction on the block, so drip must run several times per 24 h from planting until roots have penetrated the slab by ~2 cm).", "url": "https://www.grodan.com/global/crops/sweet-pepper/the-right-block-slab-interaction-ensures-healthy-plants/", "peer": False},
    "grodan-slab-handling": {"cite": "Grodan (ROCKWOOL Group). Handling and placing of the slabs. Technical sheet TS 3.3 (saturate the slab inside the wrapper and allow it to stand before cutting drainage).", "url": "https://www.grodan.com/syssiteassets/downloads/tools--services/english/ts-3-3-handling-the-slabs-en.pdf", "peer": False},
    "grodan-drainage-stages": {"cite": "Grodan (ROCKWOOL Group). Cutting drainage holes in stages is good for plants and saves water (small slits first to hold the slab wetter during rooting-in, enlarged later for the generative phase).", "url": "https://www.grodan.com/global/knowledge/root-zone-management/irrigation-and-nutrients/Cutting-drainage-holes-in-stages-is-good-for-plants-and-saves-water/", "peer": False},
    "bougoul2006-slab-density": {"cite": "Bougoul S, Boulard T (2006). Water dynamics in two rockwool slab growing substrates of contrasting densities. <em>Scientia Horticulturae</em> 107(4):399-404 (near saturation, conductivity depends on a few large pores; most water is held below ~5 cm suction).", "url": "https://doi.org/10.1016/j.scienta.2005.11.007", "peer": True},
    "bougoul2005-stonewool-hydraulic": {"cite": "Bougoul S, Ruy S, de Groot F, Boulard T (2005). Hydraulic and physical properties of stonewool substrates in horticulture. <em>Scientia Horticulturae</em> 104(4):391-405.", "url": "https://doi.org/10.1016/j.scienta.2005.01.018", "peer": True},
    "dasilva1998-slab-distribution": {"cite": "da Silva FF, Wallach R, Polak A, Chen Y (1998). Distribution of nutrients and water in rockwool slabs. <em>Scientia Horticulturae</em> 72(3-4):277-285 (water content stratifies with height above the drain plane).", "url": "https://doi.org/10.1016/S0304-4238(97)00144-1", "peer": True},
    "wtg-e37-bones": {"cite": "We The Growers podcast, episode 37 (Bones Grows). Practitioner protocol for block-on-slab veg irrigation: hourly block shots on 18/6 for 3-4 days, slab water content ignored until ~day 10 of flower, 30-35% dryback targets and EC stacking through weeks 2-3. Practitioner interview, not peer-reviewed.", "url": "", "peer": False},
    "wtg-e31-sipkoi": {"cite": "We The Growers podcast, episode 31 (Sipkoi). Practitioner protocol for veg-block feeding, 25-30% runoff targets, and an end-of-cycle flush performed by diluting the batch tank rather than applying plain water. Practitioner interview, not peer-reviewed.", "url": "", "peer": False},
    # ---- hash rosin pressing ----
    "pressclub-temp": {"cite": "The Press Club. Rosin press temperature guide (cold-press vs hot-press bands by material; yield/terpene trade). Industry technical guide, not peer-reviewed.", "url": "https://thepressclub.co/blogs/tips-tricks/rosin-press-temperature-guide", "peer": False},
    "pressclub-pressure": {"cite": "The Press Club. Rosin press pressure guide (effective PSI at the bag; ramp-to-flow technique). Industry technical guide.", "url": "https://thepressclub.co/blogs/tips-tricks/rosin-press-pressure-guide", "peer": False},
    "pressclub-thca": {"cite": "The Press Club. How to make THCa rosin (yield expectations and separation practice). Industry technical guide.", "url": "https://thepressclub.co/blogs/tips-tricks/how-to-make-thca-rosin", "peer": False},
    "pressclub-static": {"cite": "The Press Club. Cleaning dry sift with rubber-glove static tech. Industry technical guide.", "url": "https://thepressclub.co/blogs/tips-tricks/cleaning-dry-sift-with-rubber-glove-static-tech", "peer": False},
    "lowtemp-diamonds": {"cite": "Lowtemp Industries. How to make solventless diamonds (THCa crystallisation from rosin; decarb destroys diamond potential). Manufacturer knowledge base.", "url": "https://www.lowtemp-plates.com/blogs/knowledge/how-to-make-solventless-diamonds", "peer": False},
    "lowtemp-carts": {"cite": "Lowtemp Industries. How to make 100% solventless rosin cartridges (decarb, degas, fridge test, fill). Manufacturer knowledge base.", "url": "https://www.lowtemp-plates.com/blogs/knowledge/how-to-make-100-solventless-rosin-cartridges-lowtemp-industries", "peer": False},
    "triminator-tempchart": {"cite": "Triminator. Rosin press temperature chart (per-material bands and dwell times). Manufacturer technical guide.", "url": "https://thetriminator.com/rosin-press-temp-chart/", "peer": False},
    "triminator-coldcure": {"cite": "Triminator. How to cold-cure rosin (sealed-jar cold cure for badder; temperature and timing bands). Manufacturer technical guide.", "url": "https://thetriminator.com/how-to-cold-cure-rosin/", "peer": False},
    "triminator-carts": {"cite": "Triminator. How to make rosin carts (fill temperature and stability testing). Manufacturer technical guide.", "url": "https://thetriminator.com/how-to-make-rosin-carts/", "peer": False},
    "hightimes-bubbleman": {"cite": "Richardson M (&lsquo;Bubbleman&rsquo;). Tricks &amp; tips to make full-melt dry sift hash. <em>High Times</em> (140/107/70 µm three-screen method).", "url": "https://hightimes.com/grow/tricks-tips-to-make-full-melt-dry-sift-hash/", "peer": False},
    "hashtek-thca-tek": {"cite": "Hashtek. Mechanical THCa separation tek (progressive low-temperature pressing, ~105-135 °F; hot starts dissolve THCa into the terpene fraction). Practitioner tek.", "url": "https://hashtek.ca/thca-tek/", "peer": False},
    "hashtek-jam-tek": {"cite": "Hashtek. Rosin jam tek (sealed jar ~93 °C for 1-2 h, then ~38 °C for 1-2 weeks to crystallise). Practitioner tek.", "url": "https://hashtek.ca/jam-tek/", "peer": False},
    "hashtek-decarb": {"cite": "Hashtek. Decarb experiment: lid vs no lid (sealed 71 °C/142 h decarb lost ~3% total terpenes; open-air decarb lost ~12%, monoterpenes worst; mason lids self-vent ~5 psi). Practitioner experiment.", "url": "https://hashtek.ca/decarb-experiment-lid-vs-no-lid/", "peer": False},
    "resinator-bubblepress": {"cite": "The Original Resinator. How to press bubble hash into rosin (wash-to-press workflow). Manufacturer guide.", "url": "https://www.theoriginalresinator.com/blog/how-to-press-bubble-hash-into-rosin/", "peer": False},
    "wang2016-decarb": {"cite": "Wang M, Wang Y-H, Avula B, et al. (2016). Decarboxylation study of acidic cannabinoids: a novel approach using ultra-high-performance supercritical fluid chromatography/photodiode array-mass spectrometry. <em>Cannabis and Cannabinoid Research</em> 1(1):262-271.", "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC5549281/", "peer": True},
    "eyal2023-terpenes": {"cite": "Eyal AM, Berneman Zeitouni D, Tal D, et al. (2023). Vapor pressure, vaping, and corrections to misconceptions related to medical cannabis' active pharmaceutical ingredients' physical properties and compositions. <em>Cannabis and Cannabinoid Research</em> 8(3):414-425.", "url": "https://pmc.ncbi.nlm.nih.gov/articles/PMC10249740/", "peer": True},
}
...
for _genmod in ("data.refs_gen", "data.refs_gen4", "data.refs_gen5", "data.refs_gen6", "data.refs_gen7", "data.refs_gen8", "data.refs_gen9",
                ...
                "data.refs_add_tc_playbook", "data.refs_add_dwc"):
    try:
