...
def panel_html(slug: str) -> str:
    ...
    if slug == "slab-irrigation-strategy":
        return """<div class="evidence-panel"><div class="evidence-h"><div class="evidence-kicker">Evidence and limits</div><p class="evidence-lead">Figure captions distinguish manufacturer guidance, calculated examples and conceptual illustrations. Drawings are not measurements of this room.</p></div><div class="evidence-grid"><div class="evidence-col solid"><div class="evidence-badge">Attributed sources</div><p>Manufacturer instructions apply to the named product and procedure. Practitioner programmes are attributed examples; neither is automatically peer-reviewed evidence.</p></div><div class="evidence-col provisional"><div class="evidence-badge">CORPUS / INFERRED</div><p>Unvalidated stage bands, layout assumptions and synthetic traces support explanation only. Verify product dimensions, delivered flow and crop response before adopting a programme.</p></div><div class="evidence-col operational"><div class="evidence-badge">OPERATIONAL</div><p>No figure establishes a validated room setpoint. Automation requires named local SOP or telemetry evidence, calibrated measurements and recorded operating limits.</p></div></div></div>"""
    e = get(slug)
    def lis(items):
