...
body{background:var(--paper);color:var(--ink-2);font-family:var(--sans);font-size:16.5px;line-height:1.68}
...
@media(max-width:1180px){ .doc{grid-template-columns:1fr} .rail{display:none} }
